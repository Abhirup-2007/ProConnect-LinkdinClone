...
import {
  ...
  getAllCommnet,
  postComment,
} from "@/config/redux/action/postAction/page";
import {
  getAboutUser,
  getAllUsers,
...
import { resetPostId } from "@/config/redux/reducer/postReducet/page";
                    ...
                    <div className={styles.singleCard__profileContainer}>
                      ...
                      <div>
                        ...
                        <div className={styles.optionsContainer}>
                          <div
                            className={styles.singaleOption__optionsContainer}
                            onClick={async () => {
                              await dispatch(incremantPostLike(post._id));
                              await dispatch(getAllPosts());
                            }}
                          >
                            <svg
                          ...
                          <div
                            className={styles.singaleOption__optionsContainer}
                            onClick={() =>
                              dispatch(getAllCommnet({ post_id: post._id }))
                            }
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              >
                    ...
                    postState.comments.map((comment, index) => (
                      <div className={styles.singleComment} key={index}>
                        <div className={styles.singleComment_profileContainer}>
                            ...
                            <div>
                            <p style={{fontWidth:"bold" , fontSize:"1.2rem"}}>{comment.userId.name}</p>
                ...
                <div className={styles.postCommentContainer}>
                  ...
                  />
                  <div
                    className={styles.postCommentContainer__commnetBtn}
                    onClick={async () => {
                      await dispatch(
                        postComment({
                      ...
                      await dispatch(
                        getAllCommnet({ post_id: postState.postId }),
                      );
                    }}
                  >
                    <p>Comment</p>
